...
<!-- Inici de formulari -->
<form class="container" method="POST" action="<?= base_url('/centres/editar') ?>">
    <?= csrf_field() ?>
    ...
    <div class="row mt-3 mb-3">
        ...
        <div class="col">
            ...
            <?php if ($es_editable) : ?>
                <input type="text" class="form-control" name="codi_centre" id="codi_centre" placeholder="<?= lang('centre.codi_centre') ?>" value="<?= $codi_centre ?>" required>
            <?php else : ?>
                <input type="text" class="form-control" name="codi_centre" id="codi_centre" placeholder="<?= lang('centre.codi_centre') ?>" value="<?= $codi_centre ?>" required disabled>
            <?php endif; ?>
        </div>
        <!-- Nom centre -->
        <div class="col">
            <label for="nom_centre" class="form-label"><?= lang('centre.nom_centre') ?> *</label>
            <input type="text" class="form-control" name="nom_centre" id="nom_centre" placeholder="<?= lang('centre.nom_centre') ?>" value="<?= $nom_centre ?>" required>
        </div>
    </div>
    <div class="row mt-3 mb-3">
        <!-- Actiu -->
        <div class="col">
            <fieldset>
                ...
                <div class="form-check">
                    <?php if ($actiu == "1") : ?>
                        <input class="form-check-input" type="radio" name="centre_actiu" id="centre_actiu" value='actiu' checked required>
                    <?php else : ?>
                ...
                <div class="form-check">
                    <?php if ($actiu == "0") : ?>
                        <input class="form-check-input" type="radio" name="centre_actiu" id="centre_no_actiu" value='no_actiu' checked required>
                    <?php else : ?>
        ...
        <div class="col">
            <fieldset>
                ...
                <div class="form-check">
                    <?php if ($taller == "1") : ?>
                        <input class="form-check-input" type="radio" name="centre_taller" id="centre_taller" value='taller' checked required>
                    <?php else : ?>
                ...
                <div class="form-check">
                    <?php if ($taller == "0") : ?>
                        <input class="form-check-input" type="radio" name="centre_taller" id="centre_no_taller" value='no_taller' checked>
                    <?php else : ?>
    ...
    <div class="row mt-3 mb-3">
        ...
        <div class="col">
            ...
            <input type="tel" class="form-control" name="telefon_centre" id="telefon_centre" placeholder="<?= lang('centre.telefon_centre') ?>" value="<?= $telefon ?>">
        </div>
        <!-- Adreça -->
        <div class="col">
            <label for="adreca" class="form-label"><?= lang('centre.adreca') ?></label>
            <input type="text" class="form-control" name="adreca" id="adreca" placeholder="<?= lang('centre.adreca') ?>" value="<?= $adreca ?>">
        </div>
    </div>
    <div class="row mt-3 mb-3">
        ...
        <div class="col">
            ...
            <input type="text" class="form-control" name="nom_persona_de_contacte" id="nom_persona_de_contacte" placeholder="<?= lang('centre.nom_persona_de_contacte') ?>" value="<?= $nom_persona_contacte ?>">
        </div>
        ...
        <div class="col">
            ...
            <input type="email" class="form-control" name="correu_persona_contacte" id="correu_persona_contacte" placeholder="<?= lang('centre.nom_correu_persona_contacte_centre') ?>" value="<?= $correu_persona_contacte ?>">
        </div>
    </div>
    <!-- Població -->
    <div class="row mt-3 mb-3">
        <div class="col">
            ...
            <input class="form-control selector" name="nom_poblacio" list="datalistOptionsCentres" id="nom_poblacio" placeholder="<?= lang('centre.nom_poblacio') ?>" value="<?= $poblacio ?>" required>
        ...
        <div class="col">
            ...
            <input type="email" class="form-control" name="login_centre" id="login_centre" placeholder="<?= lang('centre.login_centre') ?>" value="<?= $login ?>">
        </div>
    </div>
    ...
    <div class="row justify-content-center mt-4">
        <div class="d-flex justify-content-center align-items-center">
            <button id="submit_editar" type="submit" class="btn btn_save rounded-pill ms-3 me-3"><i class="fa-solid fa-floppy-disk me-2"></i><?= lang('centre.buttons.update') ?></button>
        </div>
    </div>
</form>
