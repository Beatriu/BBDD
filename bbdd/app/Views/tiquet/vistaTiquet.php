        ...
        <div class="row">
            ...
            <?= csrf_field() ?>
                <div class="row">
                    ...
                    <div class="col-2">
                        <button id="submit_cercar_tiquet" type="submit" class="btn btn-primary rounded-pill ms-3 me-3"><i class="fa-solid fa-magnifying-glass"></i><?= lang('general_lang.buttons.buscar_button') ?></button>
                    </div>
