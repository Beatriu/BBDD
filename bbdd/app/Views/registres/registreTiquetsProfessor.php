    ...
    if ("<?= $role ?>" == "professor" && "<?= $repoemi ?>" == "emissor") {
        ...
        for (let i = 0; i < trs.length; i++) {
            ...
            if (!tiquets_esborrar.some(tiquets_esborrar => tiquets_esborrar.id_tiquet === item)) {
                trs[i].children[8].children[1].style.pointerEvents = "none";
                trs[i].children[8].children[1].children[0].style.color = "grey !important";
                trs[i].children[8].children[1].children[0].classList.add('text-muted');
                trs[i].children[8].children[1].children[0].classList.remove('text-primary');
            } else {
                console.log(trs);
            }
