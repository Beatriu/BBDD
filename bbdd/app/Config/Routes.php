...
$routes->get('/inventari/esborrar/(:segment)/(:segment)', 'InventarisController::registreInventari/$1/$2', ['filter'=>'Autentica']);
...
$routes->post('/inventari', 'InventarisController::triar_Inventari', ['filter'=>'Autentica']);
