...
<form class="container" method="POST" action="<?= base_url('/alumnes/afegir') ?>" enctype="multipart/form-data">
    ...
    <div class="row mt-3 mb-3">
        ...
        <div class="col">
            ...
            <input type="text" class="form-control" name="nom_alumne" id="nom_alumne" placeholder="<?= lang('alumne.nom_alumne') ?>" required>
        </div>
        <!-- Cognoms -->
        <div class="col">
            <label for="congoms_alumne" class="form-label"><?= lang('alumne.congoms_alumne') ?> *</label>
            <input type="text" class="form-control" name="congoms_alumne" id="congoms_alumne" placeholder="<?= lang('alumne.congoms_alumne') ?>" required>
        </div>
    </div>
    <div class="row mt-3 mb-3">
        <!--Correu-->
...
<script>
    ...
    function veure_pass() {
        ...
        boto.onclick = function() {censurar_pass()};
    }
    ...
    function censurar_pass(){
        ...
        boto.onclick = function()  {veure_pass()};
    }
